...
const createResepDetailTemplate = (resep) => `
            ...
            <div class="detail-item">
                <div class="img-detail"><img src="${resep.imgurl}" alt="${resep.title}"></div>
                <div class="title-detail"><h1>${resep.title}</h1></div>

                <div class="list-recipe">
                    <h3>Bahan-Bahan</h3>
                    <div class="recipe">${resep.bahan_bahan}</div>
                </div>
                <div class="step-cook">
                    <h3>${resep.cara_memasak}</h3>
                </div>
            </div>
`;
